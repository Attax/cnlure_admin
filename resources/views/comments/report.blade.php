...
<main x-data="commentPage">
    ...
    <div class="flex justify-between items-center gap-4 bg-white p-4 mb-4">
        <h1 class="text-2xl font-bold">评论举报管理</h1>
        <div class="flex space-x-2">
            <input type="text" placeholder="搜索评论内容或举报人" x-model="filters.keyword"
            ...
            <tbody class="divide-y divide-gray-200">
                <template x-for="report in reports" :key="report.id">
                    <tr>
                        ...
                        <td class="px-4 py-2 text-sm text-black underline cursor-pointer" @click="openDetail(report)" x-text="report.comment_excerpt"></td>
    ...
    <div x-show="showDetail" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white w-2/3 rounded-lg shadow-lg p-6 relative">
            ...
            <p><span class="font-medium">评论内容：</span> <span x-text="currentReport.comment_full"></span></p>
            <p><span class="font-medium">关联帖子：</span> <span x-text="currentReport.post_title"></span></p>
    ...
    <div x-show="showReject" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white w-1/3 rounded-lg shadow-lg p-6 relative">
            ...
            <select class="border w-full px-2 py-2 rounded mb-4" x-model="rejectReason">
                ...
                <option value="内容不违规">内容不违规</option>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('commentPage', () => ({
            ...
            async loadReports(page = 1) {
                ...
                const res = await fetch(`/api/report/comments?${query}`);
            ...
            approve(id) {
                fetch(`/api/report/comments/${id}/approve`, {
                    method: 'POST'
            ...
            submitReject() {
                ...
                fetch(`/api/report/comments/${this.rejectTarget.id}/reject`, {
                        method: 'POST',
                        headers: {
