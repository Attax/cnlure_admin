...
<main x-data="postPage">
    ...
    <div class="flex justify-between items-center gap-4 bg-white p-4 mb-4">
        <h1 class="text-2xl font-bold">帖子举报管理</h1>
        <div class="flex space-x-2">
            <input type="text" placeholder="搜索帖子标题或举报人" x-model="filters.keyword"
            ...
            <tbody class="divide-y divide-gray-200">
                <template x-for="report in reports" :key="report.id">
                    <tr>
                        ...
                        <td class="px-4 py-2 text-sm text-black underline cursor-pointer" @click="openPost(report.post_id)" x-text="report.post_title"></td>
    ...
    <div x-show="showDetail" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white w-2/3 rounded-lg shadow-lg p-6 relative">
            ...
            <p><span class="font-medium">帖子标题：</span> <span x-text="currentReport.post_title"></span></p>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('postPage', () => ({
            ...
            async loadReports(page = 1) {
                ...
                const res = await fetch(`/api/report/posts?${query}`);
            ...
            approve(id) {
                fetch(`/api/report/posts/${id}/approve`, {
                    method: 'POST'
            ...
            submitReject() {
                ...
                fetch(`/api/report/posts/${this.rejectTarget.id}/reject`, {
                        method: 'POST',
                        headers: {
